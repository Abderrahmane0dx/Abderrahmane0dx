<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=32&duration=2800&pause=2000&color=A9FEF7&center=true&vCenter=true&width=940&lines=Hi+%F0%9F%91%8B+I'm+Abderrahmane+Benamara;Full+Stack+Developer+%7C+Computer+Science+Student" alt="Typing SVG" />
</div>

<h3 align="center">🎓 Computer Science Student | 💻 Passionate Full Stack Developer</h3>
...
|---------|-------------|-----------|
| **🎬 CineStream** | Movie streaming platform using external APIs with a clean, responsive interface | React, JavaScript, TMDB API, Appwrite |
| **🛒 DigitalTech** | Modern e-commerce store for electronics with intuitive UX and fully responsive design | HTML, CSS, JavaScript, PHP, MySQL |
| **💬 Chatty** | Real-time messaging app with instant communication | Node.js, React, Tailwind CSS, Express.js, MongoDB, Socket.io |
| **🏨 Hotel Management** | Java application with OOP principles, GUI, and MVC pattern for automated hotel operations | Java |
